...
\begin{enumerate}[label=J\arabic*., leftmargin=*]
	\item N. Fadavi\footnotemark[1] and H. Gangammanavar, Active Set-based Inexact Proximal Bundle Algorithm for Stochastic Quadratic Programming, accepted for publication in \textit{Computational Optimization and Applications}, 2025.
