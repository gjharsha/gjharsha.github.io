...
\begin{enumerate}[label=R\arabic*., leftmargin=*] 
	...
	\item M.\ Ahn, H.\ Gangammanavar, and D.\ Troxell\footnotemark[3], Tractable Continuous Approximations for Constraint Selection via Cardinality Minimization, \ifpublic 2022 (second review). \else under second review for publication in \textit{INFORMS Journal on Optimization} (first submission: 10/2022).\fi
