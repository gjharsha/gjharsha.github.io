...
\begin{enumerate}[label=R\arabic*., leftmargin=*] 
	\item J. Forner, M. Ahn, and H. Gangammanavar, Decision-Aware Predictions for Right-Hand Side Parameters in Linear Programs, \ifpublic 2025 (first review). \else under first review for publication in the Proceedings of the INFORMS Optimization Society Conference 2025 (first submission 11/2025).\fi
	\item D. Cole, F. Pecci, O. J. Guerra, H. Gangammanavar, J. D. Jenkins, and V. M. Zavala, Graph-Based Modeling and Decomposition of Hierarchical Optimization Problems, \ifpublic 2025 (second review). \else under second review for publication in Mathematical Programming Computations (first submission 01/2025).\fi
...
%	\item J.\ Zhou, Y.\ Xiang, and H.\ Gangammanavar, Centralized Training for Partially Decentralized Execution in Multi-Agent Reinforcement Learning, \ifpublic 2025 (first review). \else under review at The Thirty-Ninth Annual Conference on Neural Information Processing Systems (first submission 05/2025).\fi
...
\section{Administrative Service}
	\begin{itemize}[leftmargin=*]
		...
		\item Member, Lyle Faculty Search Committee, 2023 -- 2024; 2025 -- present;
