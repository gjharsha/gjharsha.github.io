...
\begin{enumerate}[label=R\arabic*., leftmargin=*] 
	\item D. Cole, F. Pecci, O. J. Guerra, H. Gangammanavar, J. D. Jenkins, and V. M. Zavala, Graph-Based Modeling and Decomposition of Hierarchical Optimization Problems, \ifpublic 2025 (first revision). \else under first revision for publication in Mathematical Programming Computations (first submission 01/2025).\fi
