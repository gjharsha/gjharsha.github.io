...
\begin{enumerate}[label=J\arabic*., leftmargin=*]
	\item N. Fadavi\footnotemark[1] and H. Gangammanavar, Active Set-based Inexact Proximal Bundle Algorithm for Stochastic Quadratic Programming, accepted for publication in \textit{Computational Optimization and Applications}, 2025; (\href{https://doi.org/10.1007/s10589-025-00739-z}{DOI}).
...
\begin{enumerate}[label=R\arabic*., leftmargin=*] 
	...
	\item D. Cole, F. Pecci, O. J. Guerra, H. Gangammanavar, J. D. Jenkins, and V. M. Zavala, Graph-Based Modeling and Decomposition of Hierarchical Optimization Problems, \ifpublic 2026 (second revision). \else under second revision for publication in Mathematical Programming Computations (first submission 01/2025).\fi	
...
\begin{enumerate}[label=W\arabic*., leftmargin=*]
	\item J.\ Zhou, Y.\ Xiang, and H.\ Gangammanavar, Centralized Training for Partially Decentralized Execution in Multi-Agent Reinforcement Learning, 2026.
