...
\begin{enumerate}[label=J\arabic*., leftmargin=*]
	\item D. Cole, F. Pecci, O. J. Guerra, H. Gangammanavar, J. D. Jenkins, and V. M. Zavala, Graph-Based Modeling and Decomposition of Hierarchical Optimization Problems, accepted for publication in \textit{Mathematical Programming Computation},  2026.	
	\item N. Fadavi\footnotemark[1] and H. Gangammanavar, Active Set-based Inexact Proximal Bundle Algorithm for Stochastic Quadratic Programming, \textit{Computational Optimization and Applications}, 93, 489–521, 2026; (\href{https://doi.org/10.1007/s10589-025-00739-z}{DOI}).
	
	\item M.\ Ahn, H.\ Gangammanavar, and D.\ Troxell\footnotemark[2], Tractable Continuous Approximations for Constraint Selection via Cardinality Minimization, \textit{INFORMS Journal on Optimization}, 7(3):195-213, 2025; (\href{https://doi.org/10.1287/ijoo.2024.0038}{DOI}).
	
	\item Sakhavand, N. and Gangammanavar, H., Subproblem sampling vs. scenario reduction: efficacy comparison for stochastic programs in power systems applications, \textit{Energy Systems}, 16, 111-139, 2025; (\href{https://doi.org/10.1007/s12667-022-00558-9}{DOI}).
...
\begin{enumerate}[label=B\arabic*., leftmargin=*]
	\item H. Gangammanavar, Sampling-based Decomposition Algorithms for Multistage Stochastic Programming, \textit{Encyclopedia of Optimization}, 2022.
\end{enumerate}

\section{Conference Proceedings}
\begin{enumerate}[label=C\arabic*., leftmargin=*]
	\item K. Baker and H. Gangammanavar, Locational Marginal Prices Obey DC Circuit Laws,  accepted for publication in the \textit{Proceedings of the PowerUp Conference}, Boulder, CO, September 2026. 
	\item J. Forner\footnotemark[1], M. Ahn, and H. Gangammanavar, Decision-Aware Predictions for Right-Hand Side Parameters in Linear Programs, accepted for publication in the \textit{Proceedings of the INFORMS Optimization Society Conference}, Atlanta GA, March 2026.
...
\begin{enumerate}[label=R\arabic*., leftmargin=*] 
	\item J.\ Zhou, H.\ Gangammanavar, and Y.\ Xiang, Centralized Training for Partially Decentralized Execution in Multi-Agent Reinforcement Learning, \ifpublic 2026 (first review). \else under first review for publication in IISE Transactions (first submission 03/2026).\fi
	\item C.\ Sharma\footnotemark[4] and H.\ Gangammanavar, Data-driven Policies for Two-stage Stochastic Linear Programming, \ifpublic 2026 (first review). \else under first review for publication in Operations Research (first submission 03/2026).\fi
...
\begin{enumerate}[label=W\arabic*., leftmargin=*]
	...
	\item S. Ariyarathne\footnotemark[1] and H. Gangammanavar, New Formulations and Pricing Mechanisms for Stochastic Electricity Market Clearing Problem, \ifpublic 2026. \else under first review at European Journal of Operational Research (first submission 05/2023).\fi
...
\section{Courses\\Taught}
	...
	\ifpublic
	\begin{itemize}
		\item OREN 2360 Engineering Economy (UG): Spring 2026 (15);
		\item OREM 3360 Operations Research (UG): Spring 2017 (26), 2018 (20), 2019 (24), 2022 (19), 2023 (7), 2024 (20); Fall 2021 (25), 2022 (13);
		\item OREM 5364 Advanced Operations Research (UG): Fall 2022 (10), 2023 (5), 2025 (15); Spring 2024 (8);
		...
		\item OREM 8384 Stochastic Programming (G): Spring 2018 (13), 2020 (6); Fall 2024 (8), 2025 (5);
	\end{itemize}
	\else 	
	\begin{center}
...
\section{Ph.D. \\Supervision}
	\begin{itemize}[leftmargin=*]
		...
		\item Zhixue Wang, Ph.D. Student in Operations Research;\\		
		2025 - present. 
...
\section{Graduate Committee Service}
	...
	\begin{longtable}{p{0.25\textwidth} p{0.7\textwidth}}
			...
			Program & Students \\ 
			\hline
			Ph.D. (OREM/EMIS) 	& Ongoing: Mohammad Khalafi; \\[3pt]
								& Completed: Toby Huskinson (2025); Chengyu Ke (2023); Hedieh Ashrafi (2021); Justin B. Brown (2021); Naderehsadat Mansouri (2019); Amin Ziaeifar (2019). \\[3pt] \hline
...
\section{Professional Society\\Service}
	\begin{itemize}[leftmargin=*]
		\item Secretary, Committee on Stochastic Programming 2025 -- present;
		\item Board member, INFORMS Computing Society, 2023-2025. 
		...
		\begin{itemize}
			\item INFORMS Annual Meetings 2025 (Atlanta), 2023(Phoenix), 2022 (Indianopolis), 2021 (Anaheim), 2019 (Seattle), 2018 (Phoenix), 2014 (San Francisco). 
		\end{itemize}
		\item \textit{Referee}: INFORMS Operations Research, Journal on Computing, and Journal on Optimization; SIAM Journal on Optimization; Mathematical Programming; Computational Optimization and Applications; European Journal on Computational; IISE Transactions; Optimization Letters; Energy Systems; Omega: International Journal of Management Science; Stochastic Models; SMU Journal of Undergraduate Research; IEEE Transaction on Power Systems, Transactions on Smart Grid, and Transactions on Sustainable Energy; Electric Power Systems Research; IET Generation, Transmission and Distribution.
...
\section{Administrative Service}
	\begin{itemize}[leftmargin=*]
		\item Member and Chair, OREM Faculty Search Committee, Spring 2026.
		\item OREM/EMIS department representative on Lyle Curriculum Committee (formerly, Academic Affairs Committee), 2021 -- 2022; 2025 -- present;
		\item Member, Lyle Faculty Search Committee, 2023 -- 2024 (Endowed position in the Energy cluster); 2025 -- present (Endowed position on Advanced Manufacturing);
...
\section{Invited Seminars}
	\begin{itemize}[leftmargin=*]
		\item Physics and Engineering Department, Austin College, Sherman, TX, 2025.
